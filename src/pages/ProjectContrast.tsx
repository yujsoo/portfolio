...
function ProjectContrast() {
  return (
    <ProjectReviewLayout title={<> 웹접근성<br /> 명도대비 검사 도구</>} date="Apr.22 - Jun.22">
      <ul>
        <li className="mb-14">
          <ProjectSubTitle title="Overview." />
          <p className="leading-relaxed">
            웹 접근성 명도 대비 검사 도구를 기획하고 개발하여, 실무자들이 색상 입력만으로 빠르게 명암비를 확인할 수 있도록 구현했습니다.<br/>
            외부 에이전시 및 블로그에 소개되며, 회사 브랜드 노출 및 홍보에 기여한 프로젝트입니다.
          </p>
          <div className="mt-10">
            <Link
              target="_blank"
        ...
        <li className="mb-14">
          ...
          <div className="flex flex-col gap-2">
            <p className="relative pl-4 before:absolute before:left-0 before:top-0  before:content-['-']">
              별도의 버튼 없이 색상만 입력해도 명암비 결과를 즉시 확인할 수 있도록 구현
            </p>
            <p className="relative pl-4 before:absolute before:left-0 before:top-0  before:content-['-']">
        ...
        <li className="mb-14">
          ...
          <p className="leading-relaxed">
            당시 국내에는 대부분의 명도 대비 검사 도구가 영어로 되어 있어, 비전공자나 디자이너 분들이 접근하기에 불편함이 있다는 의견을 자주 들었습니다.<br/>
            누구나 쉽게 사용할 수 있도록, 한국어 기반의 간단하고 직관적인 도구가 있었으면 좋겠다는 생각이 개발의 출발점이었습니다.<br/>
            이 도구는 입력된 두 색상의 명도 대비 비율을 계산해 WCAG 기준을 만족하는지 확인할 수 있도록 구현되어 있으며, <br className="hidden lg:block" />
            접근성 기준에 익숙하지 않은 사용자들도 결과를 쉽게 이해할 수 있도록 즉각적인 피드백을 함께 제공합니다. <br/>
            현재는 명암비 기준 충족 여부만 제공하고 있지만, 명암비가 부족할 경우 대체 가능한 색상 조합을 추천해주는 기능이 추가된다면 더욱 실용적일 것이라 생각합니다.<br/>
            이 도구는 2022년에 제작되었고, 이후 퇴사로 인해 업데이트가 중단된 상태입니다. <br/>최근 다시 살펴보니 코드의 구조나 UX 측면에서 개선할 여지가 보여, 여건이 된다면 기능 확장과 리팩토링을 진행할 계획입니다. :)
          </p>
        </li>
