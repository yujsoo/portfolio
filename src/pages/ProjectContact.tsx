      ...
      <ul>
        ...
        <li className="mb-14">
          ...
          <p className="leading-relaxed">
            ...
            있다는 점을 확인했습니다. 이로 인해 쿼리스트링 방식으로
            <br className="hidden lg:block" /> 전달된 중요한 데이터들이
            정상적으로 전달되지 않는 문제가 있었고, 백엔드의 파싱 로직 보완과
            프론트 요청 구조 정리를 통해 문제를 해결할 수 있었습니다. <br /> 이
            경험을 통해 단순 구현을 넘어서 전체 서비스 구조를 이해하려는 자세와,
            모호한 문제 상황에서 협업을 통해 해결하는 능력을 키울 수 있었고,
            프론트엔드 개발자로서의 시야를 넓힐 수 있었습니다.
          </p>
        </li>
      </ul>
    </ProjectReviewLayout>
